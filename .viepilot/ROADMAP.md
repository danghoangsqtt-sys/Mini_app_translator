...
## Phase 9 — No-Key On-Device Translation (in_progress; 3/7 tasks complete)
...
| 9.4 | Implement lifecycle-safe Android SpeechRecognizer engine | in_progress — contract locked; assigned to TERRA 5.6 |
...
| 9 — No-Key On-Device Translation | in_progress | 3 | 7 |
