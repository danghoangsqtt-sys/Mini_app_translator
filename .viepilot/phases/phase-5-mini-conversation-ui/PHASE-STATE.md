...
- **Target release**: 1.2.0 (versionCode to be incremented at release implementation)
- **Tasks**: 0/6 complete
...
| Task | Request | Status |
|---|---|---|
| 5.1 — Product identity and documentation | `ENH-018`, `BUG-016` | in_progress |
| 5.2 — Launcher/adaptive icon set | `ENH-018` | in_progress |
| 5.3 — Material theme and design tokens | `ENH-019` | not started |
